...
We're about to start to using types from Entity Framework so we need to add the EntityFramework NuGet package.
...
```
    ' Configure Code First to ignore PluralizingTableName convention
        ...
        ' Entity Framework treats this property as a primary key by convention. 
