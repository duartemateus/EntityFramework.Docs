...
You can use stored procedures in Entity Frameworkto enable read-write scenarios over views.?You can use either a data source view or an Entity SQL view as the base?table for retrieving data?and for change processing?by stored procedures.
